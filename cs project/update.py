...
h  = int(file_data[8])
file.close()
sql_update_query = """Update Medicine_Database set medname = %s , medtype=%s, slotno=%s, quan=%s, isdate=%s, mandate=%s, expdate=%s, price=%s where refno = %s"""
input_data = (b,i,c,d,e,f,g,h,a)
